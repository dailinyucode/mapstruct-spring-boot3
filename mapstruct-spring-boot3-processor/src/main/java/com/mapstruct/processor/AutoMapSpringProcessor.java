package com.mapstruct.processor;

import com.mapstruct.core.annotations.AutoMapSpring;
...
import static com.mapstruct.processor.Const.BASE_PACKAGE;
...
public class AutoMapSpringProcessor extends AbstractProcessor {
    ...
    protected static final String SPRING_MAPPER_CONFIG = "com.mapstruct.core.annotations.AutoMapSpring";
    protected static final String SPRING_CONVERTER_FULL_NAME = "com.mapstruct.core.BaseAutoMapper";
